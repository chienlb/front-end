  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#FDF7FF_0%,#F3FAFF_45%,#FFFDF3_100%)]">
      <div className="container mx-auto px-4 pt-24 pb-20">
        <div className="rounded-[2rem] border border-white/80 bg-white/80 p-6 shadow-primary-card backdrop-blur">
        ...
        <div className="relative mt-12 space-y-6">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="rounded-[2rem] border border-white/80 bg-white/80 p-6 shadow-primary-card backdrop-blur"
            >
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[linear-gradient(180deg,#FDF7FF_0%,#F3FAFF_42%,#FFFBEF_100%)]">
      ...
      <div className="container relative mx-auto px-4 pt-24 pb-20">
        <div className="rounded-[2rem] border border-white/80 bg-white/80 p-6 shadow-primary-card backdrop-blur md:p-8">
        ...
        {!error && lessons.length === 0 && (
          <div className="mt-10 overflow-hidden rounded-[2rem] border border-white/80 bg-white/85 shadow-primary-card">
        ...
        {!error && lessons.length > 0 && (
          <div className="relative mt-12">
            ...
            {sortedLessons.map((lesson, idx) => {
              ...
              const cardContent = (
                <div
                  className={`group relative rounded-[2rem] border p-5 shadow-primary-card transition md:p-6 ${
                    locked
