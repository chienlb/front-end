...
import { Search, Loader2, FileQuestion, CalendarDays, CircleAlert, Dumbbell, UserRound, BookOpen } from "lucide-react";
...
export default function TeacherPracticeHistoryPage() {
  ...
  const fetchStudents = async () => {
    try {
      ...
      setStudents([]);
      setErrorMessage("Không tải được danh sách học viên.");
    } finally {
